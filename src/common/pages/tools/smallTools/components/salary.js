		...
		return (
			<div style={{ marginTop: 80 }}>
				<Row type="flex" justify="center" className="rowItem">
					<Col span={10}>
						<Input type="number" addonBefore="应发工资：" placeholder="请输入应发工资" addonAfter="￥" onChange={this.handleChange} className="rowInput" />
					</Col>
				</Row>
				<Row type="flex" justify="center" className="rowItem">
					<Col span={10}>
						<Input addonBefore="养老保险：" addonAfter="￥" placeholder="等待应发工资输入" readOnly value={this.state.old} />
					</Col>
				</Row>
				<Row type="flex" justify="center" className="rowItem">
					<Col span={10}>
						<Input addonBefore="医疗保险：" addonAfter="￥" placeholder="等待应发工资输入" readOnly value={this.state.medical} />
					</Col>
				</Row>
				<Row type="flex" justify="center" className="rowItem">
					<Col span={10}>
						<Input addonBefore="失业保险：" addonAfter="￥" placeholder="等待应发工资输入" readOnly value={this.state.offwork} />
					</Col>
				</Row>
				<Row type="flex" justify="center" className="rowItem">
					<Col span={10}>
						<Input addonBefore="住房公积：" addonAfter="￥" placeholder="等待应发工资输入" readOnly value={this.state.house} />
					</Col>
				</Row>
				<Row type="flex" justify="center" className="rowItem">
					<Col span={10}>
						<Input addonBefore="税前工资：" addonAfter="￥" placeholder="等待应发工资输入" readOnly value={this.state.pretax} id="red" />
					</Col>
				</Row>
				<Row type="flex" justify="center" className="rowItem">
					<Col span={10}>
						<Input addonBefore="个人税收：" addonAfter="￥" placeholder="等待应发工资输入" readOnly value={this.state.tax} />
					</Col>
				</Row>
				<Row type="flex" justify="center" className="rowItem">
					<Col span={10}>
						<Input addonBefore="税后工资：" addonAfter="￥" placeholder="等待应发工资输入" readOnly value={this.state.output} id="blue" />
					</Col>
				</Row>
				<Row type="flex" justify="center" className="rowItem">
					<Col span={10}>
